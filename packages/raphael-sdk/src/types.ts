export type PlatformConfig = {
  ...
  version?: string;
  features?: { reviews: boolean; automations: boolean; connectors: boolean };
};

export type Module = { id: string; name: string; description?: string | null };
...
export type ReviewDiff = {
  ...
  electrical: { net: string; change: string }[];
